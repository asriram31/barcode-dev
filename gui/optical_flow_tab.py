...
def create_optical_flow_tab(
    ...
    of_f_step_spin = ttk.Spinbox(
        ...
        increment=1,
        textvariable=config_data["gui_optical_flow"]["frame_step"],
        width=7
    )
    ...
    win_size_spin = ttk.Spinbox(
        frame, from_=1, to=1000,
        increment=1,
        textvariable=config_data["gui_optical_flow"]["win_size"],
        width=7
    )
    ...
    downsample_spin = ttk.Spinbox(
        frame, from_=1, to=1000,
        increment=1,
        textvariable=config_data["gui_optical_flow"]["downsample"],
        width=7
    )
    ...
    um_pixel_spin = ttk.Spinbox(
        ...
        increment=10**-3,
        textvariable=config_data["gui_optical_flow"]["um_pixel_ratio"],
        width=9
    )
    ...
    frame_interval_spin = ttk.Spinbox(
        ...
        increment=10**-3,
        textvariable=config_data["gui_optical_flow"]["exposure_time"],
        width=7
    )
    ...
    of_pf_eval_spin = ttk.Spinbox(
        ...
        increment=0.01,
        textvariable=config_data["gui_optical_flow"]["percentage_frames_evaluated"],
        format="%.2f",
        width=7
    )
